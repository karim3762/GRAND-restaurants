	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="compo.php"</script>';
			}
		}
	}
}
	...
	<body>
		...
		<div class="container">
			...
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="compo.php?action=add&id=<?php echo $row["id"]; ?>">
					<div class="main">
...
<br>
			...
			?>
			<br/>
			<button onclick="window.location.href='mainmenu.php'" class="compo">Back to Main Menu</button>
