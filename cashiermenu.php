...
<html>
	...
	<img src="lastlogo4.png" alt="img" >
			...
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="cashiermenu.php?action=add&id=<?php echo $row["id"]; ?>">
					<div class="main">
			...
			?>
			<br>
		<button onclick="window.location.href='sandwichcashier.php'" class="sandwichcashier">Compose a Sandwich</button>
<br>
       	...
       	foreach($_SESSION['cashier_cart'] as $array){
       	 $sql="INSERT INTO cashierorder(name,price,quantity,total) values ('".$array['name']."','".$array['price']."','".$array['quantity']."','".$total."')";
       			...
       			echo '<script>alert("The Order Submitted Successfully"); alert("Please Review the Order with the Customer");window.location.href="cashiermenu.php";
       			</script>';
       }
